		...
		if (!processing) {
			if (qname.toLowerCase().equals("epc")){
				for (int i = 0; i < attrs.getLength(); i++){
					if (attrs.getQName(i).toLowerCase().equals("epcid")){
		...
		if (processing){
			...
			if (qname.toLowerCase().equals("epc")){
				...
				for (int i = 0; i < attrs.getLength(); i++){
					...
					}else if(attrs.getQName(i).toLowerCase().equals("type")){
						currNode.setType(attrs.getValue(i));
					}
				}
				...
				for (int i = 0; i < attrs.getLength(); i++){
					if (attrs.getQName(i).toLowerCase().equals("id")){
						...
						currArc.setType(attrs.getValue(i));
						//System.out.println("attrs.getValue(i)"+attrs.getValue(i).length()+"negative".length()+","+attrs.getValue(i));
					}
				}
				currState = STATE_ARC;
